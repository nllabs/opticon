...
_CLIENT_ID     = config.get('Netatmo', 'CLIENT_ID')   # Your client ID from Netatmo app registration at http://dev.netatmo.com/dev/listapps
_CLIENT_SECRET = config.get('Netatmo', 'CLIENT_SECRET')   # Your client app secret   '     '
_USERNAME      = config.get('Netatmo', 'USERNAME')   # Your netatmo account username
_PASSWORD      = config.get('Netatmo', 'PASSWORD')   # Your netatmo account password
